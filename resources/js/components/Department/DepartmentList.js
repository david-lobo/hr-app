...
class DepartmentList extends Component {
  ...
  getData(page) {
    ...
    axios.get("/departments" + params).then(response => {
      this.setState({
    ...
    return (
      <div className="container py-4">
        <div className="row justify-content-center">
          <div className="col-md-12"><h3>All Departments</h3></div>
          <div className="col-md-12">
            <Link className="btn btn-primary btn-sm mb-3" to="/departments/create">
              Create Department
            </Link>
